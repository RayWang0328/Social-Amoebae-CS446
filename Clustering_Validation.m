...
%simulating. 
rows = 10; %the width of the environment- each row increases width by 3.6 ...
                                                                        %cm
columns = 10; % the height of the environment- each row increases height...
                                                                %by 3.6 cm
...
infectionTime=20;%every 4 hours infection will spread in the clusters
...
infectionLimit=100; %after 12 hours of persistent infection, amoeba will die
...
infectedReproductionRate = 1.0;%how fast amoebas reproduce(1.2 = 20% growth,
%1.0 = 0% growth).
uninfectedReproductionRate=1.0;   
...
for i = 2:numIterations
    ...
    newClusterPos = [];
    fprintf("Iteration %d\n", i)
    for p = 1:aliveClusters
        xpos = oldClusterPos(p,1);
        ypos = oldClusterPos(p,2); 
        fprintf("Cluster Position: %d, %d, Cluster Size: %d, Cluster Infection: %d\n"...
            ,xpos,ypos,getClusterSize(xpos,ypos,environment),...
            getInfected(xpos,ypos,environment))
    end
    fprintf("\n")
