...
amoebasPerCell = 100; %number of amoebes per grid square (how we want to 
    ...
    for j = 1:aliveClusters
        ...
        elseif fruitingBodyIter(i-1) == 1
            ...
            if rem(i,infectionTime)==0 && clusterSize~=0 %this checks to make
               ...
               fprintf("Probability of Infection: %d\n",...
                        infectedPercentage)
               ...
               fprintf("Percent of New Infection: %d\n\n",...
                        newInfection/clusterUninfected) 
